package com.jlit.uaas.db.util;


/**
* @author Strive QQ:13217595
*/
public class Md5
{
    ...
    */
    ...
    public static void main(String args[]) {
    	...
    	Md5 m = new Md5();
    	String passwd = m.getMD5Str("xinyongjin");
    	String sc = "71FEAED29454";
    	String realPsw = passwd + sc;
    	System.out.println("realPsw=="+realPsw);
    	String mixPsw = m.getMD5Str(realPsw);
    	System.out.println("password=="+passwd);
    	System.out.println("password=="+mixPsw);
   
    System.out.println("keyBean(\"a\"):"+m.getMD5Str("1a145a23d6e47aadfe2063f1f951e691test"));
    }
    }