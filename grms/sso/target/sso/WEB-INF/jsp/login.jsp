            ...
            <div class="content-wrap">
                <div class="login-wrap">
                	<form id="authZForm" action="oauth2/authorize" method="post" >
	                    <div class="account">合立运维管理平台</div>
	                    ...
	                    <span id="logining_span"  class="btn" style="text-align: center;display: none;"><img alt="" src="/sso/images/loading.gif" style="width: 30px;height: 30px;margin-top: 5px;"></span>
                    </form>
                </div>
            </div>
        </div>
