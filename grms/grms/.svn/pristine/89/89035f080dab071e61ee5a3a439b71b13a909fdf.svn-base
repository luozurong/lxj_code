...
public class AuthorLoginVo implements java.io.Serializable{
	...
	public String toString() {
		return "AuthorLoginVo [authorId=" + authorId + ", roleId=" + roleId + ", resourceParentId=" + resourceParentId
				+ ", resourceId=" + resourceId + ", resourceMenuId=" + resourceMenuId + ", resourceDesc=" + resourceDesc
				+ ", resourceApp=" + resourceApp + ", resourseOrder=" + resourseOrder + ", resourseIcon=" + resourseIcon
				+ ", resourceCode=" + resourceCode + ", resourceUrl=" + resourceUrl + ", resourseType=" + resourseType
				+ ", createTime=" + createTime + ", modifiedTime=" + modifiedTime + ", note=" + note + ", authVoList="
				+ authVoList + "]";
	}
