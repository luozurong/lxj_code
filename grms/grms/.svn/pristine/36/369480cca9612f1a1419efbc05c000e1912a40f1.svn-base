...
public class LoginForSystemLoginVo implements java.io.Serializable{
	...
	public String toString() {
		return "LoginForSystemLoginVo [result=" + result + ", reason=" + reason + ", token=" + token + ", userType="
				+ userType + ", userAccount=" + userAccount + ", userTypeName=" + userTypeName + ", roleName="
				+ roleName + ", roleId=" + roleId + ", roleType=" + roleType + ", userDetail=" + userDetail
				+ ", dataArea=" + dataArea + ", userList=" + userList + ", resourceMenu1=" + resourceMenu1
				+ ", resourceMenu2=" + resourceMenu2 + ", resourceButton=" + resourceButton + "]";
	}
