...
public class UserDetailLoginVo implements java.io.Serializable{
	...
	public String toString() {
		return "UserDetailLoginVo [userDetailId=" + userDetailId + ", departId=" + departId + ", departName="
				+ departName + ", userId=" + userId + ", sex=" + sex + ", post=" + post + ", email=" + email
				+ ", mobile=" + mobile + ", name=" + name + ", address=" + address + ", nickname=" + nickname
				+ ", createTime=" + createTime + ", modifiedTime=" + modifiedTime + ", note=" + note + "]";
	}
