...
<html style="height: 100%;">
	...
	<script type="text/javascript"	src="<%=basePath%>/js/zhongheDepart/projectActionYWDetail.js"></script>
	...
	<body >
		<div class="wrap">
			...
			<input id="projectCode" type="hidden" value="${projectCode}"/>
			...
			<div style="background-color: rgba(22, 155, 213, 1);height: 40px;float: right;border-radius:5px;margin: 20px" >
				<div style="visibility: visible;margin:10px;color: #FFFFFF" onclick="downloadFile2()">
			...
			<div id="projectProductList"  style='width:97%;height:300px'>
				<table id="SQ_datagrid" pagination="false">
					<thead>
						<tr>
			...
			<!-- 用户运营 -->
			<div id="projectProductList2"  style='width:97%;height:300px'>
				<table id="zhCommunity2_datagrid">
					<thead>
						<tr>
							<th data-options="field:'businessType',width:100,align:'center',formatter:oganiOper">执行部门</th>
							<th data-options="field:'productType',width:100,align:'center'">类型</th>
							<th data-options="field:'productMenu',width:100,align:'center'">产品清单</th>
							<th data-options="field:'productSpec',width:100,align:'center'">产品规格</th>
							<th data-options="field:'buyNum',width:100,align:'center'">购买数量</th>
							<th data-options="field:'beginTime',width:100,align:'center',formatter:formatDate">执行开始日期</th>
							<th data-options="field:'endTime',width:100,align:'center',formatter:formatDate">执行结束日期</th>
							<th data-options="field:'areaNum',width:200,align:'center',formatter:formatOper">已选小区</th>
						</tr>
					</thead>
				</table>
			...
			<!-- 媒管运营 -->
			<div id="projectProductList3"  style='width:97%;height:300px'>
				<table id="zhCommunity3_datagrid">
					<thead>
						<tr>
							<th data-options="field:'businessType',width:100,align:'center',formatter:oganiOper">执行部门</th>
							<th data-options="field:'productType',width:100,align:'center'">类型</th>
			...
			<!-- 电商运营 -->
			<div id="projectProductList4"  style='width:97%;height:300px'>
				<table id="zhCommunity4_datagrid">
					<thead>
						<tr>
							<th data-options="field:'businessType',width:100,align:'center',formatter:oganiOper">执行部门</th>
							<th data-options="field:'productType',width:100,align:'center'">类型</th>
