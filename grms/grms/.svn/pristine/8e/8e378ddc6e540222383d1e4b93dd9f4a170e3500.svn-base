		...
		<div class="wrap">
			...
			<div class="conditions-select clearfix">
				...
				<div class="account1 fl">
					<input value="" style="padding-left:5px;" id="name"/>
				</div>
				<div class="search fl" onclick="selectAll()" id="search">搜索</div>
				<div class="upload fl" onclick="upload()" id="upload">上传</div>
				<div class="delete fl" onclick="dealDeleteMany()" id="batchDelete">批量删除</div>
			</div>
