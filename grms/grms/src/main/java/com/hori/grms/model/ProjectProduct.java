...
public class ProjectProduct {
    ...
    //场地置换时间
    private Date fieldExchangeTime;
    ...
    public Date getFieldExchangeTime() {
        return fieldExchangeTime;
    }
    public void setFieldExchangeTime(Date fieldExchangeTime) {
        this.fieldExchangeTime = fieldExchangeTime;
    }
}