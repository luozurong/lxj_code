 ...
 * 社区运营执行清单Vo
 * @author hehj
 * @datetime 2018年8月10日 下午1:54:11
 */
public class CommunityProjectActionVo {
	// 项目清单主键id
	...
	// 异常处理结果:1:置换场地 2:扣款 3:暂停 4:完成 5:终止
	...
	public String toString() {
		return "CommunityProjectActionVo [projectProductId=" + projectProductId + ", beginTime=" + beginTime
				+ ", areaName=" + areaName + ", province=" + province + ", provinceName=" + provinceName + ", city="
				+ city + ", cityName=" + cityName + ", country=" + country + ", countryName=" + countryName
				+ ", areaAddress=" + areaAddress + ", businessType=" + businessType + ", departmentId=" + departmentId
				+ ", departmentName=" + departmentName + ", fieldName=" + fieldName + ", projectActionId="
				+ projectActionId + ", actionCode=" + actionCode + ", projectName=" + projectName + ", actionStatus="
				+ actionStatus + ", exceptionStatus=" + exceptionStatus + ", exceptionResult=" + exceptionResult
				+ ", receiveAccount=" + receiveAccount + ", receiveName=" + receiveName + ", recevieTime=" + recevieTime
				+ "]";
	}
