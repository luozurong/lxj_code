...
public interface ProjectActionExceptionService {
	 ...
	 * @throws Exception 
	 */
	void changeConfirmStatus(String exceptionRecordId, Short confirmStatus) throws Exception;
	/**
	 * 获取清单异常上报记录
	 * @param queryBean
	 * @return
	...
	/**
	 * 根据项目执行编号或者项目编号更新确认状态
	 * @param code
	 * @param type
	 * @return
	 */
	int updateConfirmStatus(String code, Integer type);
	 ...
	 * @return
	 */
	ProjectActionException getById(String id);
}
