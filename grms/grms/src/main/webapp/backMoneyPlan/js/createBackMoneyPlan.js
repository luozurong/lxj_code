...
function copyTemplate(){
	...
	htl +=		'<span>';
	htl +=			'<input id="planMoney'+i+'" onBlur="moneyBlur(this)" class="planMoneys" style="height: 30px;width: 180px; border: 1px solid #ccc;" name="planMoney" type="text"/>';
	htl +=		'</span>	';
	htl +=	'</div>	';
	htl += '</div>	';
