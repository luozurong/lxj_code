...
<style type="text/css">
  .window{
	...
	<body>
		<input type=hidden id='detailId'  value="${currentId}" />
		<input type=hidden id='flagId'  value="${flag}" />
		<input type=hidden id='account' value="${currentAccount }">
		<div class="wrap">
		...
		<div class="content-wrap">						
			<div class="addCustomerMessager">
				...
				<div class="addCustomer-item">
					...
					<textarea id = "remark" rows="5" cols="40" style="border: 1px solid #ccc;padding:5px;" maxlength="200" readonly="readonly"></textarea>
				</div>
				<div class="addCustomer-item">
				...
				<div class="addCustomer-item" id="transferOffId">
					...
					<div class="content-wrap" style="display: inline-block;vertical-align: top;margin-top:0;padding-left:0;">
						<input id="acceptor" class="easyui-validatebox" readonly="readonly" data-options="required:true" type="text" onclick="toTransfer()">
					</div>
				</div>
				...
				<div class="bottomButtonBox" id="buttonsOffId">
				    <Button class="buleButton"  onclick="confirmSave()" style="margin-right:40px">确认</Button>				    
