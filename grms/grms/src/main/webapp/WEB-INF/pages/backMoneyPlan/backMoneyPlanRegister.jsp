...
<html style="height: 100%;">
			...
			<c:forEach items="${list}" var="backMoneyPlanPeriods" varStatus="status">
				...
				<div class="table-wrap">
					<div>
						...
						<c:if test="${ backMoneyPlanPeriods.type==3}">
							扣款
						</c:if>
						</span>	
					</div>	
				...
				<div class="table-wrap">
					<div>
						...
						<span><fmt:formatDate value="${backMoneyPlanPeriods.planBackTime}" pattern='yyyy-MM-dd'/></span>
					</div>	
				</div>	
				<div class="table-wrap">
					<div>
	...
	<script type="text/javascript"	src="<%=basePath%>/backMoneyPlan/js/backMoneyPlanRegister.js"></script>
	</body>
</html>