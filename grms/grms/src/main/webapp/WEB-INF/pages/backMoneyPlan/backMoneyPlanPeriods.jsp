...
<div class="workorder-search">
	<div class="workorder-input">
        <select id="selectCondition" class="easyui-combobox" style="width: 150px"  name="dept">
        ...
        <select id="selectCondition2" class="easyui-combobox" style="width: 150px" name="dept2" onChange="change(this)">
        	<option value="">请选择</option>
            <option value="1">收款类型</option>
        </select>
        <select id="condition2" class="easyui-combobox" style="width: 150px"  name="dept3">
