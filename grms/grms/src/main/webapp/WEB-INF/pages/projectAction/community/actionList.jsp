...
<html>
	...
	<body>
        ...
        <input id="pageFlag" value="community" type="hidden"/><!-- 当前页面的标志，确保唯一性，用于与异常记录页面的项目跳转 -->
		...
		<div class="wrap">
			...
			<div class="conditions-select clearfix"  style="width:1657px;">
				...
				<div class="search fl" id="selectAll" style="margin-left:-20px;margin-top:22px;display:none;" onclick="selectAll()">搜索</div>
			</div>
