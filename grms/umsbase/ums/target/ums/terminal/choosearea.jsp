...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/terminal/css/choosearea.css"/>
</head>
<body>
	<div class="header">
  ...
  <!--<div id="tt" class="easyui-tabs" fit="true" style="width:100%;">-->
    ...
    <div class="btnBox">
    	...
    	<div class="saveCancel">
    		<span class="saveBtn btnStyle1">保存</span>
    		<span class="cancelBtn btnStyle2" onclick="cancelArea()">取消</span>
    	</div>
    </div>
  ...
  <!--</div>-->
    ...
    <script type="text/javascript"	src="<%=basePath%>/terminal/js/choosearea.js"></script>
</body>
</html>