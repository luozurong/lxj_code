...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="terminal/css/view.css" />
</head>
...
<form action="" id="ff">
<input type="hidden" id="bagId" value="${strategyBag.id}">
<div class="content">
    <div class="content1">
            ...
            <div id="${st.id}" class="rule-box">
                ...
                <div class="set_brightness_box">
                    ...
                    <div class="num_box clearfix" >
                        <div class="box1">
                            <div id="liangdu${st.id}" class="liangdu fl"></div>
                    ...
                    <div class="num_box clearfix">
                        <div class="box1">
                            <div id="yinliang${st.id}" class="yinliang fl"></div>
                    ...
                    <div class="num_box clearfix">
                        <div class="box1">
                            <div id="audioyinliang${st.id}" class="audioyinliang fl"></div>
                            <div class="num-yin fl">%</div>
                        </div>
                    </div>
                </div>
...
<%--<div class="save_box">--%>
    <%--<div class="save" onclick="dosave()">保存</div>--%>
<%--</div>--%>
</form>
...
<script type="text/javascript" src="terminal/js/view.js"></script>
</body>
