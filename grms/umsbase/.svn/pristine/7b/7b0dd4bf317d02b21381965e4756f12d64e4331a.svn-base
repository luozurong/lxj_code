...
import com.hori.util.MyBeanUtils;
...
public class JdbcDao extends SimpleJdbcTemplate{
	...
	public Long getCountForJdbcParam(String  sql,Object... objs) {
		Number number = this.jdbcTemplate.queryForObject(sql,Long.class,objs);
		long totalCount = (number!=null?number.longValue():0); 
		return totalCount;
	...
	public Integer countByJdbc(String sql, Object... param) {
		Number number = this.jdbcTemplate.queryForObject(sql,Integer.class,param);
