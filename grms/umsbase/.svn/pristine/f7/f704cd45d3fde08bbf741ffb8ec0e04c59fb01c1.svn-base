...
public class RandomUtil {
	...
	public static final String numberAndBigChar = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	/**
	...
	public static void main(String[] args) {
		System.out.println(generateUpperString(5));
		...
		//System.out.println(generateZeroString(16));
