...
/*commodityId="15244515886822836bd6fe8d45f49f52";
areaCode="4400100001";
token="153050125537da30ed29b8e0436f85b7";
...
$(document).ready(function() {
	...
	$(".evalucateButton").on("click", function() {
		...
		showActivity(host + "/mms/html5/supermarket/evaluate.htm?commodityId=" + commodityId, "全部评价");
	});
	...
	$("#favorite").on("click", function() {
		...
		function getFavorite() {
			var str = "{\"body\":{\"sellerId\":\"" + sellerId + "\",\"price\":\"" + price + "\",\"commodityId\":\"" + commodityId + "\",\"type\":\"1\",\"commodityType\":1},\"header\":{\"token\":\"" + token + "\",\"time_stamp\":\"" + time_stamp + "\"}}";
	...
	$.ajax({
		...
		success: function(data) {
			...
			if(photo.length > 1) {
				...
				$("#first-photo>img").attr("ssrc", last_photo);
				$("#first-photo>img").css("background-image", "url(" + last_photo + ")");
				$("#last-photo>img").attr("ssrc", first_photo);
				$("#last-photo>img").css("background-image", "url(" + first_photo + ")");
