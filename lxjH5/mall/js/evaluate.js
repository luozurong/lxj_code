...
/*commodityId="1524450825124211ca42857f44a89375";
areaCode="4400100001";
token="15248273805438644f18c69846f195eb";
        ...
        getDatejson: function(doneFunc) {
            ...
            this.$http.jsonp(this.apiurl + "?str=" + encodeURI(paramData), {
                ...
                if (response.body.result == 0) {
                    for(var i=0; i< response.body.commentList.length;i++){
                        this.commodityList.push(response.body.commentList[i]);
                    }
                    console.log(response.body.commentList);
                    if(response.body.commentList.length < 10){
                        this.doneFlag = false;
                    }
                }else{
                	vue.doneFlag = false;
