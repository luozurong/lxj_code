...
!function (a, b) {
    ...
    a.options.show && (c = a.extend(!0, c, a.options.show)), a.currentWebview = null, a.isHomePage = !1, a.extend(!0, a.global, b), a.extend(!0, a.options, b), a.waitingOptions = function (b) {
        return a.extend(!0, {}, {autoShow: !0, title: ""}, b)
    ...
    var e = "mui-scrollbar", f = "mui-scrollbar-indicator", g = e + "-vertical", h = e + "-horizontal", i = "mui-active", j = {
        ...
        init: function (b, c) {
            ...
            for (var a = this.snaps, b = a.length, c = 0, d = -1, e = 0, f = 0, g = 0, h = 0, j = 0; b > j; j++) {
                var k = a[j], l = k.offsetLeft, m = k.offsetWidth;
            ...
            if (b.target === c.wrapper) {
                ...
                if (m) {
                    ...
                    if (n.length > 0)for (var g = 0, h = n.length; h > g; g++)n[g].classList[g === d.slideNumber ? "add" : "remove"](i); else {
                        ...
                        if (o)o.innerText = d.slideNumber + 1; else for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++)p[g].classList[g === d.slideNumber ? "add" : "remove"](i)
                    }
                }
                b.stopPropagation()
            }
...
}(mui, window, document), function (a, b, c) {
