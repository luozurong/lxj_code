...
function(e, t) {
	...
	e.DtPicker = e.Class.extend({
		...
		_createHours: function(e) {
			...
			var createHoursstar = parseInt(sessionStorage.getItem("timehourstar"));
			var createHoursend = parseInt(sessionStorage.getItem("timehourend"));
			if (i.customData.h) n = i.customData.h;
			else
				for (var r = createHoursstar; createHoursend >= r; r++) {
		...
		_parseValue: function(e) {
			...
			if (e) {
				...
				var a = new Date;
				var myHour1 = a.getHours();
				var myDay1=a.getDate();
				var MySetTimeHour = parseInt(sessionStorage.getItem("timeinterval"));
				var MycreateHoursend = parseInt(sessionStorage.getItem("timehourend"));
				var newDay=parseInt(sessionStorage.getItem("NewDay"));
				var myHour2 = myHour1 + MySetTimeHour;
				var myDay2=myDay1 + 1;
				a.setHours(myHour2);
				a.setDate(newDay);
				if(MySetTimeHour<=23&&myHour2>MycreateHoursend){
		...
		_create: function(e) {
			...
			e.beginYear = e.beginYear || i.getFullYear(), e.endYear = e.endYear || i.getFullYear() + 5;
			var a = t.ui;
