...
(function($, window, document, undefined) {
	...
	Picker.prototype.startInertiaScroll = function(event) {
		sessionStorage.setItem("endscrollState","false");
		var self = this;
		var point = event.changedTouches ? event.changedTouches[0] : event;
		/** 
		 * 缓动代码
	...
	Picker.prototype.endScroll = function() {
		...
		self.triggerChange(true,true);
		sessionStorage.setItem("endscrollState","true");
		//console.log(999999999);
	};

	Picker.prototype.triggerChange = function(force,boolEnd) {
		var self = this;
		setTimeout(function() {
			...
			//	console.log('change:' + index+"           "+JSON.stringify(item));
			}
